...
import com.farubaba.http.body.FileRequestBody;
import com.farubaba.http.body.FormRequestBody;
import com.farubaba.http.body.HeaderedBody;
import com.farubaba.http.body.MultipartRequestBody;
import com.farubaba.http.body.StreamRequestBody;
...
import com.farubaba.http.ssl.SslUtil;
...
import com.farubaba.root.utils.CloseUtil;
import com.farubaba.root.utils.IOUtil;
...
public class OkHttpAdapter implements HttpAdapter{
	...
	private JsonService jsonService = JsonFactory.getInstance().getJsonService();
	...
	private RequestBody prepareStreamBody(final StreamRequestBody content) {
		RequestBody body = null;
		if(content != null){
	...
	private <M extends IModel> void enqueueRequest(Call call, final RequestContext<M> requestContext) {
